...
export const defaultPortfolioContent: PortfolioContent = {
  ...
  works: [
    ...
    },
    {
      ...
      description:
        'Built a unified operational workspace for creator support, campaign management, and cross-market execution across global teams.',
    ...
    },
    {
      ...
      description:
        'Defined a scalable component and governance model for internal operations products, improving consistency across workflows and markets.',
    ...
    },
    {
      ...
      description:
        'Explored a moderation dashboard that combines AI summaries, risk signals, and human review flows for higher decision efficiency.',
      client: 'Trust & Safety',
      role: 'Product Design Lead',
      blocks: [
        {
