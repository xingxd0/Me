  ...
  works: [
    {
      ...
      description:
        'Led platform governance and AI design ecosystems across 17 business lines at TikTok San Jose. Optimized cross-continental operational efficiency and digital workflows by defining highly scalable underlying design systems and systems architecture, setting an industry benchmark for complex human-computer collaboration and enterprise digital transformation.',
    ...
    },
    {
      ...
      description:
        'Dual winner of the 2026 iF DESIGN AWARD and 2025 Red Dot Laureate. Serving as an active Grand Award Jury Member for international design competitions, focusing on the professional evaluation and standard-setting of human-computer interaction (HCI) and digital products.',
    ...
    },
    {
      ...
      description:
        "Led the core interaction design team, driving innovative product experiences for Kuaishou's social commerce. Established rigorous design language systems (DLS) to deliver seamless and commercially viable product experiences for millions of active users.",
    ...
    {
      id: '4',
      title: 'Global Creator Ops Control Center',
      category: 'Creator Platform',
      year: '2024',
      imageUrl: 'https://images.unsplash.com/photo-1516321497487-e288fb19713f?q=80&w=2000&auto=format&fit=crop',
      description:
        'Built a unified operational workspace for global, cross-functional teams. Streamlined creator support, campaign management, and cross-market execution, significantly enhancing collaboration efficiency across distributed global teams.',
      client: 'TikTok Creator Operations',
      role: 'Design Manager',
      blocks: [
        {
          id: '4-heading-1',
          type: 'heading',
          content: 'Creating one control center for global creator operations',
        },
        {
          id: '4-paragraph-1',
          type: 'paragraph',
          content:
            'This concept project consolidates fragmented creator operations workflows into a single workspace for task routing, campaign coordination, and partner health monitoring.',
        },
        {
          id: '4-image-1',
          type: 'image',
          url: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=2000&auto=format&fit=crop',
          caption: 'Unified creator operations overview.',
        },
        {
          id: '4-paragraph-2',
          type: 'paragraph',
          content:
            'The system reduces context switching and supports global teams with clearer prioritization, modular dashboards, and faster issue resolution.',
        },
      ],
    },
    {
      id: '5',
      title: 'Design System for Enterprise Ops Tooling',
      category: 'Design System',
      year: '2025',
      imageUrl: 'https://images.unsplash.com/photo-1558655146-9f40138edfeb?q=80&w=2000&auto=format&fit=crop',
      description:
        'Defined scalable component libraries and governance models for internal enterprise operations tooling. Standardized experience across multiple workflows and markets to systematically elevate enterprise infrastructure efficiency.',
      client: 'Internal Enterprise Platforms',
      role: 'Design Lead',
      blocks: [
        {
          id: '5-heading-1',
          type: 'heading',
          content: 'Standardizing enterprise tooling through a modular design system',
        },
        {
          id: '5-paragraph-1',
          type: 'paragraph',
          content:
            'The project establishes a shared UI language for operations products, covering layout rules, component states, token usage, and cross-team contribution patterns.',
        },
        {
          id: '5-image-1',
          type: 'image',
          url: 'https://images.unsplash.com/photo-1545239351-1141bd82e8a6?q=80&w=2000&auto=format&fit=crop',
          caption: 'Systemized patterns for complex ops interfaces.',
        },
        {
          id: '5-paragraph-2',
          type: 'paragraph',
          content:
            'By unifying patterns and review rules, teams can ship faster while preserving clarity, accessibility, and design quality across business lines.',
        },
      ],
    },
    {
      id: '6',
      title: 'AI-Assisted Moderation Dashboard',
      category: 'AI Workflow',
      year: '2026',
      imageUrl: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?q=80&w=2000&auto=format&fit=crop',
      description:
        'Explored next-generation decision-making dashboards combining AI intelligent summaries, multi-dimensional risk signals, and human review workflows. Significantly elevated decision-making efficiency in high-pressure, complex scenarios through refined human-computer interaction (HCI) design.',
      client: 'Trust & Safety',
      role: 'Product Design Lead',
      blocks: [
        {
          id: '6-heading-1',
          type: 'heading',
          content: 'Combining AI signals with human review in one decision flow',
        },
        {
          id: '6-paragraph-1',
          type: 'paragraph',
          content:
            'This concept focuses on helping moderation teams scan large volumes of cases through AI summaries, confidence markers, and action recommendations.',
        },
        {
          id: '6-image-1',
          type: 'image',
          url: 'https://images.unsplash.com/photo-1516321165247-4aa89a48be28?q=80&w=2000&auto=format&fit=crop',
          caption: 'AI-assisted decision support for moderation teams.',
        },
        {
          id: '6-paragraph-2',
          type: 'paragraph',
          content:
            'The interface balances speed and accountability by keeping source evidence visible while streamlining repetitive review and escalation tasks.',
        },
      ],
    },
  ],
